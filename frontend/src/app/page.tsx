...
import RepositoryTrigger from "@/components/RepositoryTrigger";
...
async function getStats(workflows: WorkflowSummary[]) {
  ...
  const avgConfidence =
    ...
    (workflows.filter((w) => w.confidence_score != null)
      .length || 1);
    ...
    <div className="space-y-8">
      ...
      <div className="text-center py-8 space-y-3">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto">
          A real multi-agent AI pipeline that diagnoses
          failed deployments, generates fixes,
          validates them, and creates pull requests —
          fully autonomously.
        </p>
      ...
      {/* NEW: Real GitHub Repository Flow */}
      <RepositoryTrigger />
