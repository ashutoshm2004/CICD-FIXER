...
async function getStats(workflows: WorkflowSummary[]) {
  ...
  const avgConfidence =
    workflows
      ...
      .reduce(
        (sum, w) => sum + (w.confidence_score ?? 0),
        0
      ) /
    (workflows.filter(
      (w) => w.confidence_score != null
    ).length || 1);
        ...
        <div className="grid xl:grid-cols-[1fr_0.7fr_240px] gap-6 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-zinc-400 text-lg max-w-2xl leading-relaxed">
              ...
              Autonomous AI agents detect deployment failures,
              perform root-cause analysis, generate remediation patches,
              validate recovery pipelines, and deploy intelligent fixes
              across your infrastructure in real-time.
          ...
          <div className="panel rounded-[28px] p-5 space-y-5 max-w-[240px] w-full">
            ...
            {[
              ...
              <div
                key={label}
                className="border-b border-white/[0.05] pb-5 last:border-0"
              >

                <p className="muted-label mb-4">
                  {label}
                </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        {[
          ...
          return (
            ...
            <div
              key={item.label}
              className="metric-card rounded-[28px] p-7"
            >
      ...
      <section className="grid xl:grid-cols-[1fr_380px] gap-6">
        ...
        <div className="panel rounded-[32px] p-8">
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="text-red-500 text-sm uppercase tracking-[0.2em]">
              Live Feed
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-5">
            ...
            {[
              ...
              <div
                key={step}
                className="pipeline-node rounded-[24px] p-6 text-center"
              >
                ...
                <h3 className="text-white font-bold tracking-[0.12em]">
                  {step}
                </h3>
        ...
        <div className="panel rounded-[32px] p-7">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-red-500 text-xs uppercase tracking-[0.2em]">
              ● LIVE
            </div>
          </div>
